  ...
  return (
    <div className="flex min-h-screen flex-col bg-background text-foreground">
      <SEOHead
        ...
        description="Acht Fragen zu den Pflichten aus dem EU AI Act, die in der Praxis zuerst auffallen. Ergebnis sofort im Browser, ohne E-Mail und ohne Datenversand."
        canonical="/eu-ai-act-selbstcheck"
      />

      <header className="border-b border-border/60">
        <div className="container flex items-center justify-between gap-6 py-5">
          <Link to="/" aria-label="KITech Software – Startseite" className="flex min-h-[2.75rem] items-center">
