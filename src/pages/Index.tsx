...
const processSteps = [
  {
    ...
    description:
      "Kein Blindflug. Wir analysieren Ihre Datenqualität, Prozesseignung und organisatorische Reife. Das Ergebnis ist eine objektive Entscheidungsgrundlage, kein Verkaufs-Pitch.",
  ...
  },
  {
    ...
    description:
      "Wir entwickeln maßgeschneiderte KI-Automatisierungen, die genau auf Ihre Schnittstellen passen. Auditierbar, sicher und dokumentiert.",
  ...
  },
  {
    ...
    description:
      "Von der ersten Codezeile bis zum Betrieb. Wir sorgen für iterative Entwicklung, transparente Architektur und klare Verantwortlichkeiten.",
    ...
    <Layout>
          ...
          >
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold tracking-tight mb-10 bg-gradient-to-br from-foreground via-foreground to-muted-foreground bg-clip-text">
              ...
              <span className="gradient-text inline-block h-[1.35em] overflow-hidden">
                <TextRotate
                  texts={["25+ erfolgreiche Projekte", "30 KI-Audits", "Mit Konzernerfahrung"]}
            ...
            <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto mb-10">
              Individuelle, sichere und auditierbare KI-Systeme für Ihre realen Geschäftsprozesse. Wir ersetzen
              Buzzwords durch Ingenieurskunst und Marketing-Versprechen durch technische Validierung.
            </p>
      ...
      <section className="border-y border-border bg-card/50 py-8">
        <div className="container">
          <p className="text-center text-sm text-muted-foreground mb-6">Vertraut von innovativen Unternehmen</p>
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-start">
            <div>
              ...
              >
                ...
                <p className="text-2xl sm:text-3xl font-bold gradient-text mb-6">Haltung statt Hype.</p>
                <p className="text-muted-foreground mb-6">
                  Während andere "KI-Agenturen" Wrapper um ChatGPT bauen, entwickeln wir robuste Systeme, die tief in
                  Ihre bestehende IT-Landschaft integriert sind.
                </p>
                <p className="text-muted-foreground mb-8">
                  Wir verstehen KI nicht als Spielerei, sondern als kritisches Infrastruktur-Element. Datensicherheit,
                  Nachvollziehbarkeit und wirtschaftliche Wartbarkeit stehen bei uns vor dem nächsten viralen Trend.
                </p>
      ...
      <section className="py-20 lg:py-28 bg-card/50">
        <div className="container">
          ...
          >
            <h2 className="text-3xl sm:text-4xl font-bold mb-4">Unser Vorgehen: Strukturiert & Transparent</h2>
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Wir verkaufen keine Wunder, sondern ingenieurtechnische Lösungen. Unser Prozess minimiert Risiken und
              maximiert Nutzen.
            </p>
          </motion.div>
      ...
      <section className="py-20 lg:py-28">
        <div className="container">
          ...
          >
            <div>
              <h2 className="text-3xl sm:text-4xl font-bold mb-4">Echte Probleme. Echte Lösungen.</h2>
              <p className="text-muted-foreground max-w-2xl">
                Wir sprechen nicht über Möglichkeiten, sondern über Ergebnisse. Hier sind Auszüge aus unserer Arbeit.
              </p>
            </div>
              ...
              >
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div>
                    ...
                    <span className="text-xs text-muted-foreground uppercase tracking-wider">{study.subtitle}</span>
                  </div>
                </div>
      ...
      <section className="py-20 lg:py-28">
        <div className="container">
          ...
          >
            <h2 className="text-3xl sm:text-4xl font-bold mb-4 text-foreground">Bereit für KI mit Substanz?</h2>
            <p className="text-muted-foreground max-w-2xl mx-auto mb-8">
              Lassen Sie uns in einem unverbindlichen Gespräch prüfen, wo KI in Ihrem Unternehmen echten Mehrwert
              stiftet – und wo nicht.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
